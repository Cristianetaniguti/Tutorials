...
*NOTE*: Results are not plotted in this vignette, please check the vignette in [GitHub version](https://statgen-esalq.github.io/tutorials/onemap/Outcrossing_Populations.html).
...
*NOTE*: Some results in this session are not shown in this vignette, please check the vignette in [GitHub version](https://statgen-esalq.github.io/tutorials/onemap/Outcrossing_Populations.html).
...
*NOTE*: Results in this session are not plotted in this vignette, please check the vignette in [GitHub version](https://statgen-esalq.github.io/tutorials/onemap/Outcrossing_Populations.html).
...
```{r, echo=TRUE, fig=TRUE, eval=FALSE}
...
```{r, echo=TRUE, results='hide', echo=FALSE, eval=FALSE}
...
```{r}
(parents_haplot <- parents_haplotypes(LG1_final))
```
...
```{r}
parents_haplotypes(LG1_final,LG2_final, group_names=c("LG1","LG2"))
```
