...
author: "Statistical Genetics Lab - Department of Genetics - Luiz de Queiroz College of Agriculture - University of São Paulo"
output: pdf_document
---
...
```{r, echo=FALSE}
onemap_example_out <- read_onemap(inputfile = system.file("extdata/onemap_example_out.raw",
                                                          package = "onemap"))
``` 
...
draw_map2(LG2_final, CHR3_final, tag= c("SNP17", "SNP18", "M29"), 
          main = "Chromosome 3", 
          group.names = c("Only linkage", "With genome"), 
          centered = TRUE, output = "map_comp2.png")
``` 
...
```{r, echo=FALSE, eval=FALSE}
time_spent <- data.frame("without-parallelization"= rep(0,5), 
                         "with-parallelization" =rep(0,5))
rownames(time_spent) <- c("rcd", "record_map", "ug_map", 
                          "mds_onemap", "map")
```
